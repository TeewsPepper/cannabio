      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <input
            ...
            {...register('nombre', { required: 'El nombre es obligatorio', minLength: { value: 2, message: 'Mínimo 2 caracteres' }, maxLength: { value: 50, message: 'Máximo 50 caracteres' } })}
          />
          ...
          <input
            ...
            {...register('email', { required: 'El email es obligatorio', pattern: { value: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: 'Email inválido' }, maxLength: { value: 100, message: 'Máximo 100 caracteres' } })}
          />
          ...
          <textarea
            ...
            {...register('mensaje', { required: 'El mensaje es obligatorio', minLength: { value: 10, message: 'Mínimo 10 caracteres' }, maxLength: { value: 1000, message: 'Máximo 1000 caracteres' } })}
          />
